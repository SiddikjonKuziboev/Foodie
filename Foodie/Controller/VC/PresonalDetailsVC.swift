...
class PresonalDetailsVC: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        if let dat = UserDefaults.standard.data(forKey: "22"){
            ...
            if let decode = try? decoder.decode(PersonalDetailsDM.self, from: dat) {
                txtName.text = decode.name
                txtPhoneNumber.text = decode.phoneNumber
            }
    }
    }
    ...
    @IBAction func editBtnPressed(_ sender: Any) {
        ...
        dat = PersonalDetailsDM(name: txtName.text!, email: txtEmail.text!, phoneNumber: txtPhoneNumber.text!, address: txtViewAddress.text!)
            ...
            if let encode = try? encoder.encode(dat) {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        // Check for the media type
          ...
          case kUTTypeMovie:
            ...
            _ = info[UIImagePickerController.InfoKey.mediaURL] as! URL
